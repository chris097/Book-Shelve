...
export const Details = ({ removeBookDetails, title, author }) => {
    ...
    return(
        ...
        <div className="self-center justify-center flex font-rubik-400 font-medium">
            <div className="absolute top-1 bg-white shadow-2xl w-1/2 h-auto z-50 transition-transform m-auto overflow-hidden rounded-md ">
                ...
                <div className="px-8 mt-2 flex">
                    ...
                    <div className="flex-1">
                        <div className="font-normal h-72 overflow-y-auto w-full">Lorem ipsum dolor, sit amet consectetur adipisicing elit. 
                        ...
                        <div className="flex justify-between">
                            <div><svg className="w-6 text-gray-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div className="flex">
                                <svg className="w-6 text-gray-300 mr-7" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-5.586z" />
                                </svg>
                                <svg className="w-6 text-gray-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
