            ...
            <div className="absolute top-5 pb-3 bg-white shadow-2xl md:w-1/2 w-5/6 mx-2 h-auto z-50 transition-transform overflow-hidden rounded-md ">
                ...
                <div className="md:px-6 mt-2 flex px-3">
                    <div className="overflow-x-visible w-1/2">
                        <img className="w-screen bg-no-repeat bg-cover h-48 rounded-sm" src={imageUrl !== ""||[] ? imageUrl : img2} alt="book_image"/>
                ...
                <div className="md:px-8 px-3 mt-4">
                    <div className="flex">
                    <div>32 comments</div>
                    <div><svg className="w-6 ml-36 text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
