        ...
        <>
            <div className="fixed w-screen h-screen bg-gray-900 left-0 top-0 opacity-40 transition ease-in-out delay-1000"></div>
                <div className="self-center justify-center flex">
                    <div className="absolute top-1 bg-white shadow-2xl w-96 h-auto z-50 transition-transform m-auto">
                        <div className="flex justify-between px-3 py-2 bg-gray-50">
                            <div className="ml-4">Add a book</div>
                            <div className=""><svg className="w-5 text-gray-500 hover:text-red-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                            </svg></div>
                        </div>
                        <form action="" className="px-7">
                            <div className="mt-5">
                                <label className="block" htmlFor="title">Title</label>
                                <input className="input-box" type="text" placeholder="Book tilte"/>
                            </div>
                            <div className="mt-2">
                            ...
                            <div className="mt-2">
                                ...
                                <textarea className="w-full border border-gray-200 px-1 h-16 outline-none" id="description" placeholder="Write a text"></textarea>
                            </div>
