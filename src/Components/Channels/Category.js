    ...
    return(
        <div className="dark:bg-gray-800 transition duration-500 px-10 bg-gray-50 h-16 py-4 flex md:justify-between fixed w-full mt-20 font-rubik">
            <div className="flex">
                ...
                <div className="text-lg flex ml-2 md:ml-0 md:mt-0 mt-1 dark:text-gray-300 ">Categories</div>
                <div className="flex ml-32 w-full">
                    <div className="dark:bg-gray-600 dark:text-gray-300 bg-gray-100 px-10 h-9 pt-1.5 rounded-full md:visible invisible text-primaryColor">Fiction</div>
                    ...
                    <div className="md:mt-2 mt-1.5 absolute md:relative md:left-0 left-40 dark:text-gray-300 ">Showing <span className="font-bold">{book.length} </span>Result(s)</div>
                </div>
            </div>
            <div className="flex">
                <div className="dark:bg-gray-600 dark:text-gray-300 flex bg-white w-28 mr-10 rounded-full px-2 h-9 md:visible invisible">
