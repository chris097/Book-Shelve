    ...
    return(
        <>
            <div className="dark:bg-gray-800 transition duration-500 md:px-10 px-4 bg-white shadow-sm flex h-20 py-4 fixed w-full">
                ...
                <button onClick={getBookModal} className="dark:text-gray-300 absolute right-8 flex w-40 invisible md:visible bg-primaryColor rounded-full outline-none py-3 px-5 hover:bg-blue-400 transition-all ease-in-out">
                <span className="">
